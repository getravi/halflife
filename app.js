...
const STATIC_WEIGHTS = {
  ...
  tasks: {
    ...
    // Phase 2
    'p2-jax-core': 16, 'p2-scaling-book': 8, 'p2-pytorch-distributed': 12, 'p2-cs336-systems': 8, 'p2-inference-serving': 12, 'p2-milestone': 4,
    // Phase 3
    'p3-stats': 8, 'p3-agent-harness': 8, 'p3-finetuning': 4, 'p3-rl-posttraining': 8, 'p3-eval-infra': 8, 'p3-judge-validation': 4, 'p3-benchmark-audit': 8, 'p3-safety-evals': 4, 'p3-environment': 4, 'p3-milestone': 4,
    // Phase 4
  ...
  subtasks: {
    ...
    "phase1.html::p1-karpathy-hero::Build micrograd first": 3,
    "phase1.html::p1-karpathy-hero::Then makemore, all the way through": 3,
    "phase1.html::p1-karpathy-hero::Diagnostics you keep": 3,
    "phase1.html::p1-karpathy-hero::Exit check: autograd from memory": 3,
    ...
    "phase2.html::p2-jax-core::Purity and the tracing model": 2,
    "phase2.html::p2-jax-core::grad, value_and_grad, and jit": 2,
    "phase2.html::p2-jax-core::vmap": 2,
    "phase2.html::p2-jax-core::lax.scan and structured control flow": 2,
    "phase2.html::p2-jax-core::Explicit sharding and meshes": 2,
    "phase2.html::p2-jax-core::Collectives and shard_map": 2,
    "phase2.html::p2-jax-core::Read pmap, never write it": 2,
    "phase2.html::p2-jax-core::Get devices without a budget": 2,
    "phase2.html::p2-scaling-book::Chapters 1–2: rooflines and the hardware": 1,
    "phase2.html::p2-scaling-book::Chapters 3–4: sharding and transformer math": 1,
    "phase2.html::p2-scaling-book::Chapter 12: how to think about GPUs": 1,
    "phase2.html::p2-scaling-book::Chinchilla as the anchor": 1,
    "phase2.html::p2-scaling-book::Inference-aware and data-constrained scaling": 1,
    "phase2.html::p2-scaling-book::The GPU counterpart": 1,
    "phase2.html::p2-pytorch-distributed::FSDP2": 2,
    "phase2.html::p2-pytorch-distributed::DTensor and DeviceMesh": 2,
    "phase2.html::p2-pytorch-distributed::Tensor parallel and 2D parallelism": 2,
    "phase2.html::p2-pytorch-distributed::Read torchtitan": 2,
    "phase2.html::p2-pytorch-distributed::Activation checkpointing and gradient accumulation": 2,
    "phase2.html::p2-pytorch-distributed::bf16 and fp8": 2,
    "phase2.html::p2-pytorch-distributed::NCCL and OOM debugging": 2,
    "phase2.html::p2-pytorch-distributed::Distributed checkpoint and resume": 2,
    "phase2.html::p2-cs336-systems::Watch the systems lectures": 2,
    "phase2.html::p2-cs336-systems::Benchmark and profile before optimising": 2,
    "phase2.html::p2-cs336-systems::Triton fundamentals": 2,
    "phase2.html::p2-cs336-systems::FlashAttention-2 forward and backward in Triton": 2,
    "phase2.html::p2-cs336-systems::DDP from scratch, then optimizer state sharding": 2,
    "phase2.html::p2-inference-serving::Stand up vLLM": 1,
    "phase2.html::p2-inference-serving::Continuous batching and paged KV cache": 1,
    "phase2.html::p2-inference-serving::Read the PagedAttention paper": 1,
    "phase2.html::p2-inference-serving::Prefix caching": 1,
    "phase2.html::p2-inference-serving::Tensor-parallel and multi-GPU serving": 1,
    "phase2.html::p2-inference-serving::Throughput versus latency, measured": 1,
    "phase2.html::p2-inference-serving::Quantization": 1,
    "phase2.html::p2-inference-serving::Speculative decoding": 1,
    "phase2.html::p2-inference-serving::SGLang and structured generation": 1,
    "phase2.html::p2-inference-serving::Wire the endpoint to an RL and eval harness": 1,
    "phase3.html::p3-stats::Decide the sample size before you run anything": 2,
    "phase3.html::p3-stats::Read the error-bars paper and apply it the same day": 2,
    "phase3.html::p3-stats::Paired comparison and variance decomposition": 2,
    "phase3.html::p3-stats::Multiple comparisons and effect sizes": 2,
    "phase3.html::p3-stats::Exit check: redo an old result honestly": 2,
    "phase3.html::p3-agent-harness::The loop, from a blank file": 2,
    "phase3.html::p3-agent-harness::Tool schema design is the actual skill": 2,
    "phase3.html::p3-agent-harness::Multi-turn state, error recovery, hard limits": 2,
    "phase3.html::p3-agent-harness::Context compaction": 2,
    "phase3.html::p3-agent-harness::Speak MCP": 2,
    "phase3.html::p3-finetuning::LoRA from scratch — it is two matrices and a scale factor": 1,
    "phase3.html::p3-finetuning::One real SFT run with peft and trl": 1,
    "phase3.html::p3-finetuning::Dataset card and leakage check": 1,
    "phase3.html::p3-rl-posttraining::Run a GRPO-family loop on a verifiable task": 2,
    "phase3.html::p3-rl-posttraining::Know where GRPO and DAPO came from": 2,
    "phase3.html::p3-rl-posttraining::Read the RLVR capability debate honestly": 2,
    "phase3.html::p3-rl-posttraining::Learn what actually moves the number": 2,
    "phase3.html::p3-rl-posttraining::Fill in the post-training map": 2,
    "phase3.html::p3-eval-infra::A job queue over checkpoints": 2,
    "phase3.html::p3-eval-infra::Caching and dedupe that you can trust": 2,
    "phase3.html::p3-eval-infra::Sandbox the agentic tasks": 2,
    "phase3.html::p3-eval-infra::Per-sample cost and token accounting": 2,
    "phase3.html::p3-eval-infra::A dashboard someone else can read": 2,
    "phase3.html::p3-judge-validation::Label the gold set yourself first": 1,
    "phase3.html::p3-judge-validation::Run the bias battery": 1,
    "phase3.html::p3-judge-validation::Rubrics and checklists, not scalar scores": 1,
    "phase3.html::p3-judge-validation::Calibration drift and version pinning": 1,
    "phase3.html::p3-benchmark-audit::Pick a live benchmark and a specific published result": 1,
    "phase3.html::p3-benchmark-audit::Read the protocol before you read the numbers": 1,
    "phase3.html::p3-benchmark-audit::Reproduce it with your own harness": 1,
    "phase3.html::p3-benchmark-audit::Learn where computer-use numbers hide": 1,
    "phase3.html::p3-benchmark-audit::Measure what a single number hides": 1,
    "phase3.html::p3-benchmark-audit::Report the discrepancy": 1,
    "phase3.html::p3-benchmark-audit::Learn which benchmarks are dead and still cited": 1,
    "phase3.html::p3-safety-evals::Read one frontier safety framework properly": 1,
    "phase3.html::p3-safety-evals::Sandbagging: when the eval is adversarial": 1,
    "phase3.html::p3-safety-evals::Evaluation awareness": 1,
    "phase3.html::p3-safety-evals::Run one real safety eval and measure the elicitation gap": 1,
    "phase3.html::p3-environment::Choose the task, and write the verifier first": 1,
    "phase3.html::p3-environment::Implement the four interfaces": 1,
    "phase3.html::p3-environment::Measure run-to-run variance and reliability": 1,
    "phase3.html::p3-environment::Make it callable from someone else's harness": 1,
    "phase4.html::p4-environment-harden::Measure run-to-run variance before you touch anything else": 2,
  ...
  steps: {
    ...
    "phase3.html::p3-benchmark-audit::Learn where computer-use numbers hide::0": 1,
    "phase3.html::p3-benchmark-audit::Learn where computer-use numbers hide::1": 1,
    "phase3.html::p3-benchmark-audit::Learn where computer-use numbers hide::2": 1,
    "phase3.html::p3-benchmark-audit::Learn where computer-use numbers hide::3": 3,
    "phase3.html::p3-benchmark-audit::Learn where computer-use numbers hide::4": 1,
    "phase3.html::p3-benchmark-audit::Learn where computer-use numbers hide::5": 3,
    "phase3.html::p3-benchmark-audit::Measure what a single number hides::0": 2,
    "phase3.html::p3-benchmark-audit::Measure what a single number hides::1": 1,
    "phase3.html::p3-benchmark-audit::Measure what a single number hides::2": 2,
    "phase3.html::p3-benchmark-audit::Measure what a single number hides::3": 1,
    "phase3.html::p3-benchmark-audit::Measure what a single number hides::4": 1,
