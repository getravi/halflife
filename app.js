...
const ALL_PHASES = {
  ...
  p2: {
    page: 'phase2.html',
    tasks: ['p2-serving', 'p2-agent-harness', 'p2-environment-v0', 'p2-stats', 'p2-judge-validation', 'p2-eval-infra', 'p2-benchmark-audit', 'p2-finetuning', 'p2-rl-posttraining', 'p2-safety-evals', 'p2-environment', 'p2-milestone']
  },
  p3: {
    page: 'phase3.html',
    tasks: ['p3-jax-core', 'p3-scaling-book', 'p3-pytorch-distributed', 'p3-cs336-systems', 'p3-milestone']
  },
  p4: {
    page: 'phase4.html',
...
const STATIC_WEIGHTS = {
  ...
  tasks: {
    ...
    // Phase 2
    'p2-serving': 8, 'p2-agent-harness': 8, 'p2-environment-v0': 8, 'p2-stats': 8, 'p2-judge-validation': 4, 'p2-eval-infra': 8, 'p2-benchmark-audit': 8, 'p2-finetuning': 4, 'p2-rl-posttraining': 8, 'p2-safety-evals': 4, 'p2-environment': 4, 'p2-milestone': 4,
    // Phase 3
    'p3-jax-core': 16, 'p3-scaling-book': 8, 'p3-pytorch-distributed': 8, 'p3-cs336-systems': 8, 'p3-milestone': 4,
    // Phase 4
  ...
  subtasks: {
    ...
    "phase2.html::p2-serving::Tensor-parallel and multi-GPU serving": 1,
    "phase2.html::p2-serving::Throughput versus latency, measured": 1,
    "phase2.html::p2-serving::Quantization": 1,
    "phase2.html::p2-serving::Speculative decoding": 1,
    "phase2.html::p2-serving::SGLang and structured generation": 1,
    ...
    "phase2.html::p2-stats::Decide the sample size before you run anything": 2,
    "phase2.html::p2-stats::Read the error-bars paper and apply it the same day": 2,
    "phase2.html::p2-stats::Paired comparison and variance decomposition": 2,
    "phase2.html::p2-stats::Multiple comparisons and effect sizes": 2,
    "phase2.html::p2-stats::Exit check: redo an old result honestly": 2,
    ...
    "phase2.html::p2-eval-infra::A job queue over checkpoints": 2,
    "phase2.html::p2-eval-infra::Caching and dedupe that you can trust": 2,
    "phase2.html::p2-eval-infra::Sandbox the agentic tasks": 2,
    "phase2.html::p2-eval-infra::Per-sample cost and token accounting": 2,
    "phase2.html::p2-eval-infra::A dashboard someone else can read": 2,
    ...
    "phase2.html::p2-finetuning::LoRA from scratch — it is two matrices and a scale factor": 1,
    "phase2.html::p2-finetuning::One real SFT run with peft and trl": 1,
    "phase2.html::p2-finetuning::Dataset card and leakage check": 1,
    "phase2.html::p2-rl-posttraining::Run a GRPO-family loop on a verifiable task": 2,
    "phase2.html::p2-rl-posttraining::Know where GRPO and DAPO came from": 2,
    "phase2.html::p2-rl-posttraining::Read the RLVR capability debate honestly": 2,
    "phase2.html::p2-rl-posttraining::Learn what actually moves the number": 2,
    "phase2.html::p2-rl-posttraining::Fill in the post-training map": 2,
    ...
    "phase2.html::p2-environment::Choose the task, and write the verifier first": 1,
    "phase2.html::p2-environment::Implement the four interfaces": 1,
    "phase2.html::p2-environment::Measure run-to-run variance and reliability": 1,
    "phase2.html::p2-environment::Make it callable from someone else's harness": 1,
  ...
  steps: {
    ...
    "phase2.html::p2-serving::Tensor-parallel and multi-GPU serving::0": 1,
    "phase2.html::p2-serving::Tensor-parallel and multi-GPU serving::1": 2,
    "phase2.html::p2-serving::Tensor-parallel and multi-GPU serving::2": 3,
    "phase2.html::p2-serving::Tensor-parallel and multi-GPU serving::3": 1,
    "phase2.html::p2-serving::Tensor-parallel and multi-GPU serving::4": 1,
    "phase2.html::p2-serving::Tensor-parallel and multi-GPU serving::5": 1,
    ...
    "phase2.html::p2-serving::Quantization::0": 3,
    "phase2.html::p2-serving::Quantization::1": 1,
    "phase2.html::p2-serving::Quantization::2": 1,
    "phase2.html::p2-serving::Quantization::3": 1,
    "phase2.html::p2-serving::Quantization::4": 1,
    "phase2.html::p2-serving::Quantization::5": 3,
    "phase2.html::p2-serving::Speculative decoding::0": 1,
    "phase2.html::p2-serving::Speculative decoding::1": 3,
    "phase2.html::p2-serving::Speculative decoding::2": 3,
    "phase2.html::p2-serving::Speculative decoding::3": 2,
    "phase2.html::p2-serving::Speculative decoding::4": 1,
    "phase2.html::p2-serving::Speculative decoding::5": 3,
    "phase2.html::p2-serving::SGLang and structured generation::0": 1,
    "phase2.html::p2-serving::SGLang and structured generation::1": 1,
    "phase2.html::p2-serving::SGLang and structured generation::2": 2,
    "phase2.html::p2-serving::SGLang and structured generation::3": 3,
    "phase2.html::p2-serving::SGLang and structured generation::4": 3,
    "phase2.html::p2-serving::SGLang and structured generation::5": 3,
    ...
    "phase2.html::p2-finetuning::LoRA from scratch — it is two matrices and a scale factor::0": 3,
    "phase2.html::p2-finetuning::LoRA from scratch — it is two matrices and a scale factor::1": 3,
    "phase2.html::p2-finetuning::LoRA from scratch — it is two matrices and a scale factor::2": 1,
    "phase2.html::p2-finetuning::LoRA from scratch — it is two matrices and a scale factor::3": 2,
    "phase2.html::p2-finetuning::LoRA from scratch — it is two matrices and a scale factor::4": 3,
    "phase2.html::p2-finetuning::LoRA from scratch — it is two matrices and a scale factor::5": 1,
    "phase2.html::p2-finetuning::One real SFT run with peft and trl::0": 3,
    "phase2.html::p2-finetuning::One real SFT run with peft and trl::1": 2,
    "phase2.html::p2-finetuning::One real SFT run with peft and trl::2": 1,
    "phase2.html::p2-finetuning::One real SFT run with peft and trl::3": 1,
    "phase2.html::p2-finetuning::One real SFT run with peft and trl::4": 1,
    "phase2.html::p2-finetuning::One real SFT run with peft and trl::5": 1,
    "phase2.html::p2-finetuning::Dataset card and leakage check::0": 3,
    "phase2.html::p2-finetuning::Dataset card and leakage check::1": 2,
    "phase2.html::p2-finetuning::Dataset card and leakage check::2": 2,
    "phase2.html::p2-finetuning::Dataset card and leakage check::3": 1,
    "phase2.html::p2-finetuning::Dataset card and leakage check::4": 3,
    "phase2.html::p2-finetuning::Dataset card and leakage check::5": 1,
    ...
    "phase2.html::p2-environment::Choose the task, and write the verifier first::0": 3,
    "phase2.html::p2-environment::Choose the task, and write the verifier first::1": 3,
    "phase2.html::p2-environment::Choose the task, and write the verifier first::2": 3,
    "phase2.html::p2-environment::Choose the task, and write the verifier first::3": 1,
    "phase2.html::p2-environment::Choose the task, and write the verifier first::4": 1,
    "phase2.html::p2-environment::Choose the task, and write the verifier first::5": 3,
    "phase2.html::p2-environment::Implement the four interfaces::0": 1,
    "phase2.html::p2-environment::Implement the four interfaces::1": 1,
    "phase2.html::p2-environment::Implement the four interfaces::2": 3,
    "phase2.html::p2-environment::Implement the four interfaces::3": 1,
    "phase2.html::p2-environment::Implement the four interfaces::4": 3,
    "phase2.html::p2-environment::Implement the four interfaces::5": 3,
    "phase2.html::p2-environment::Measure run-to-run variance and reliability::0": 2,
    "phase2.html::p2-environment::Measure run-to-run variance and reliability::1": 1,
    "phase2.html::p2-environment::Measure run-to-run variance and reliability::2": 3,
    "phase2.html::p2-environment::Measure run-to-run variance and reliability::3": 1,
    "phase2.html::p2-environment::Measure run-to-run variance and reliability::4": 1,
    "phase2.html::p2-environment::Measure run-to-run variance and reliability::5": 3,
    "phase2.html::p2-environment::Make it callable from someone else's harness::0": 3,
    "phase2.html::p2-environment::Make it callable from someone else's harness::1": 2,
    "phase2.html::p2-environment::Make it callable from someone else's harness::2": 1,
    "phase2.html::p2-environment::Make it callable from someone else's harness::3": 2,
    "phase2.html::p2-environment::Make it callable from someone else's harness::4": 3,
    "phase2.html::p2-environment::Make it callable from someone else's harness::5": 3,
